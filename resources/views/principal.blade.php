      ...
      *** TOPBAR ***
      ...
      -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <ul class="menu list-inline mb-0">
                        <li class="list-inline-item"><i class="fa fa-phone" style="color: white"></i>&nbsp<a href="#" data-toggle="modal" data-target="#login-modal">Telefone (53) 3261-5590</a></li>
                        <li class="list-inline-item"><i class="fa fa-envelope" style="color: white"></i>&nbsp<a href="register.html">E-mail - meencantacosmeticos@gmail.com</a></li>
                    </ul>
                    </div>
                </div>
            </div>      
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container"><a href="/" class="navbar-brand home"><img src="img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
